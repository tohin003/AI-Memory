...
// Read the SVG
const svgContent = fs.readFileSync('extension_v2/logo.svg', 'utf8');
...
fs.writeFileSync('extension_v2/convert_final.html', htmlContent);
console.log('Conversion tool created at extension_v2/convert_final.html');
